...
export const TEXTOS_PADRAO: TextosApresentacao = {
  ...
  como_funciona: [
    { icone: 'sol', titulo: 'Captação', descricao: 'Os painéis captam a luz do sol.' },
    {
      icone: 'raio',
      titulo: 'Conversão',
      descricao: 'O inversor transforma essa energia em eletricidade para sua casa.',
    },
    { icone: 'grafico', titulo: 'Créditos', descricao: 'O que sobra vira crédito na conta de luz.' },
    {
      icone: 'telefone',
  ...
  fluxo: [
    { icone: 'local', titulo: 'Visita técnica', descricao: 'Avaliamos o local e conferimos as medidas.' },
    { icone: 'ferramenta', titulo: 'Montagem das estruturas', descricao: 'Fixamos as estruturas no telhado.' },
    { icone: 'sol', titulo: 'Instalação dos módulos', descricao: 'Os painéis e o inversor são instalados.' },
    { icone: 'raio', titulo: 'Conexão e testes', descricao: 'Ligamos o sistema e validamos a geração.' },
  ],
  abertura: null,
  encerramento: null,
}
